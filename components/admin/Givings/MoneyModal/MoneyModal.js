...
import DonateMoneyMemberModal from "./DonateMoneyMemberModal";
import DonateOtherMemberModal from "./DonateOtherMemberModal";

const MoneyModal = ({ handleMoneyModal }) => {
  ...
  const style = {
    ...
    modalContainer: `modalContainer bg-white rounded w-[300px] p-2 border-t-2 border-red-800 absolute top-[200px] left-[50%] translate-x-[-50%] ${
      donateMember ? "hidden" : "block"
    }`,
  };
  ...
  return (
    <section className={style.section}>
      {donateMember ? (
        <DonateMoneyMemberModal handleMoneyModal={handleMoneyModal} />
      ) : null}
      {donateGuest ? (
      ...
      <div className={style.modalContainer}>
        ...
        <div className={style.container}>
          <header className={style.headerText}>Donate money as:</header>
